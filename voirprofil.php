...
$action = isset($_GET['action'])?htmlspecialchars($_GET['action']):'consulter'; //$_GET['action'] = consulter
$membre = isset($_GET['m'])?(int) $_GET['m']:'';  //$_GET['m'] = id
// url de la forme : /voirprofil.php?m=3&action=consulter

                                            //Le switch pour afficher le profil
...
<div class="inscrii">
        ...
        Avatar actuel :
        <img class="photoprofil" src="./images/avatars/'.$data['membre_avatar'].'"
        alt="pas d avatar" />
...
//-----------------------------------------------------1er partie ressemble a registe.php
...
//------------------------------- 2e partie avec plus de retouche
    ...
    if ($i == 0) // Si $i est vide, il n'y a pas d'erreur
    {
        ...
        /*echo'<p>Cliquez <a href="./fofo.php">ici</a>
