...
echo'<p><i>Vous êtes ici</i> : <a href="./fofo.php">Index du forum</a> --> <a href="./messagesprives.php">Messagerie privée</a> --> Consulter un message</p>';
...
case "nouveau": //Nouveau mp
    ...
    <form method="post" action="postok.php?action=nouveaump" name="formulaire">
        <p>
            ...
            <img src="./images/smileys/langue.gif" title="?" alt="?" onClick="javascript:smilies(':P');return(false)" />
            <img src="./images/smileys/ok.gif" title="!" alt="!" onClick="javascript:smilies(':ok:');return(false)" />
